...
const ProtocolCard = () => {
    ...
    return (
        <div className="w-full max-w-[1000px] mx-auto dark:bg-[#0d1117]/60 bg-white rounded-2xl shadow-xl border dark:border-[#1e2d4a] border-gray-200 p-4 relative overflow-hidden">
                        ...
                        >
                            ...
                            <div className="mb-2 flex-grow z-10 relative">
                                <div className="mb-2 flex items-end gap-1.5">
                                    <span className="text-2xl font-black text-orange-500 tracking-tight font-mono">{protocol.apy}%</span>
                                    {/* APY Trend Indicator */}
