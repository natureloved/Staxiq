                ...
                <div className="flex flex-wrap items-center gap-1.5">
                    {FILTER_TYPES.map(type => (
                        <button
                            ...
                            style={{
                                background: filter === type ? 'linear-gradient(135deg, #F7931A, #e8820a)' : isDark ? '#141c2e' : '#f1f5ff',
                                color: filter === type ? '#ffffff' : isDark ? '#8899bb' : '#334155',
                                border: filter === type ? '1px solid transparent' : `1px solid ${isDark ? '#1e2d4a' : '#c5d5f0'}`,
                                boxShadow: filter === type ? '0 4px 12px #F7931A33' : 'none',
                            }}
                        >
                            {type}
                        </button>
